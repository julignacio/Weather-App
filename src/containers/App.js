...
function App() {
  ...
  return (
    <BrowserRouter>
      ...
      <Route exact path='/'render={() => <Cards cities={cities} onClose={onClose} bkgFunction={bkgFunction}/>} />
      <Route path='/about' component={About} />
      <Route path="/ciudad/:ciudadId" render={({match}) => <Ciudad match={match} api={apiKey} cities={cities} bkgFunction={bkgFunction} />} />
    </BrowserRouter>
    );
}
